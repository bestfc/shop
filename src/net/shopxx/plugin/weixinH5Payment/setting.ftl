...
<title>${message("admin.plugin.weixinH5Payment.setting")}Powered By fantiejia</title>
...
<body>
	<div class="breadcrumb">
		${message("admin.plugin.weixinH5Payment.setting")}
	</div>
	<form id="inputForm" action="update" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinH5Payment.appId")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinH5Payment.mchId")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.weixinH5Payment.apiKey")}:
				</th>
				<td>
