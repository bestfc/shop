...
(function(window) {
  ...
  var _swfPath = function() {
    ...
    if (!(document.currentScript && (jsPath = document.currentScript.src))) {
      ...
      if ("readyState" in scripts[0]) {
        ...
        jsPath = scripts[scripts.length1].src;
      } else {
        for (i = scripts.length; i--; ) {
  ...
  var _getZoomFactor = function() {
    ...
    if (typeof document.body.getBoundingClientRect === "function") {
      ...
      physicalWidth = rect.rightrect.left;
  ...
  var _getDOMObjectPosition = function(obj, defaultZIndex) {
    ...
    if (obj.getBoundingClientRect) {
      ...
      info.left = rect.left + pageXOffsetleftBorderWidth;
      info.top = rect.top + pageYOffsettopBorderWidth;
      info.width = "width" in rect ? rect.width : rect.rightrect.left;
      info.height = "height" in rect ? rect.height : rect.bottomrect.top;
    }
    return info;
  };
