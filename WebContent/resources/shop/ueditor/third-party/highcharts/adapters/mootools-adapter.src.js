...
var win = window,
	...
	legacyEvent = legacy || mooVersion === '1.3', // In versions 1.11.3 the event class is named Event, in newer versions it is named DOMEvent.
...
win.HighchartsAdapter = {
	...
	animate: function (el, params, options) {
		...
		if (isSVGElement && !el.setStyle) {
			...
			el.getStyle = el.attr;
			el.setStyle = function () { // property value is given as array in Moobreak it down
				var args = arguments;
